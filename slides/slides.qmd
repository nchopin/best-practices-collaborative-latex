...
* use `.gitignore` to tell git to ignore intermediary files. (For pdf, make
  sure you don't ignore your figs). I will send you a link to a template repo
  with a properly set `.gitignore` file.
...
* Excellent on-line book on LaTeX on [wikibooks](https://en.wikibooks.org/wiki/LaTeX)
